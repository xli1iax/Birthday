...
const MESSAGES = [
    { text: "С 20-летием, Алина! Ты невероятный человек, пусть каждый день дарит улыбку ❤️ Ты заслуживаешь всего самого лучшего!", author: "Твой Jung Kook" },
    { text: "Поздравляю с 20! Желаю счастья, любви и чтобы самые смелые мечты сбывались ✨ Ты лучшая подруга!", author: "Хоби хорсинг" },
    { text: "20 лет — это только начало! Пусть этот год принесёт много радости, ярких моментов и вдохновения. Обнимаю крепко!", author: "Пингвинчик" },
    { text: "Алина, ты — солнце! Свети ярко, живи вкусно и никогда не сдавайся 💪💖 С днём рождения!", author: "Хлеб с намазкой" },
    { text: "С 20-летием! Оставайся такой же искренней и классной. Словакия тебя любит и ждёт новых приключений 😉", author: "Карты Таро" },
    { text: "Желаю тебе океан счастья, горы достижений и море улыбок! Ты прекрасна, Алина! 🎂✨", author: "Вселенная" },
    { text: "Пусть 20-летие станет началом самых ярких приключений в твоей жизни! Обнимаю ❤️", author: "Бутылка Рома" }
];
